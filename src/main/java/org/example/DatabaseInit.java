...
public class DatabaseInit {
    private final static String DB_URL = "jdbc:postgresql://localhost:5432/swe1db";
    private final static String DB_USER = "swe1user";
    private final static String DB_PW = "swe1pw";
